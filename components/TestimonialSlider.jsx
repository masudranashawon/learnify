...
const TestimonialSlider = ({ testimonials }) => {
  ...
  return (
    <div className='testimonial-slider wrapper py-10 gap-10 min-h-screen 2xl:w-[calc(100vw-6rem)] grid grid-cols-5 h-screen items-center overflow-hidden'>
      {/* LEFT SIDE FOR SECTION CONTENT */}
      <div className='flex flex-col gap-5 justify-start items-start col-span-5 lg:col-span-2 lg:p-5'>
